...
static double r93_w(const double *n, const double *m, const double *x);
static double r93_y(const double *n, const double *m, const double *x);
static double r93_p(const double *n, const double *m, const double *x);
static double r93_z(const double *n, const double *m, const double *x);
...
void creid93(const double *r, const char *pname, const char *type,
             double *v11, double *v12, double *v22)
{
  ...
  double vc,vt,vls,vspi,vspis,vtpi;
